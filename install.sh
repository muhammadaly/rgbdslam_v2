...
git clone https://github.com/felixendres/g2o.git $G2O_REPO_DIR
...
git clone -b kinetic https://github.com/muhammadaly/rgbdslam_v2 $WORKSPACE/src/rgbdslam
